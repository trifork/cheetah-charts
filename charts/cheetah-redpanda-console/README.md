...
![Version: 0.0.1](https://img.shields.io/badge/Version-0.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.4.5](https://img.shields.io/badge/AppVersion-v2.4.5-informational?style=flat-square)
...
### [service.nodePort](https://artifacthub.io/packages/helm/redpanda-data/console?modal=values&path=service.nodePort)
