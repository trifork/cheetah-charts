...
| job.savepointTriggerNonce | int | `0` | DEPRECATED: Use `FlinkStateSnapshot` crd instead. Change this to trigger a savepoint manually, see more here: <https://nightlies.apache.org/flink/flink-kubernetes-operator-docs-main/docs/custom-resource/job-management/> |
| job.initialSavepointPath | string | `""` | DEPRECATED: Use `FlinkStateSnapshot` crd instead. Change this to force a manual recovery checkpoint, see more here: <https://nightlies.apache.org/flink/flink-kubernetes-operator-docs-main/docs/custom-resource/job-management/> |
