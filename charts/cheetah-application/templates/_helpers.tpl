...
*/}}
{{- define "cheetah-application.name" -}}
...
*/}}
{{- define "cheetah-application.fullname" -}}
...
*/}}
{{- define "cheetah-application.chart" -}}
...
Selector labels
*/}}
{{- define "cheetah-application.selectorLabels" -}}
...
{{- default (include "cheetah-application.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{/*
Create a command from a string or array
*/}}
{{- define "cheetah-application.command" -}}
  {{- if typeIs "string" .Values.command -}}
    {{- .Values.command -}}
  {{- else -}}
